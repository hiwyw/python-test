...
"""
# Application is the glue between one or more service definitions,
...
# The names of the needed types for implementing
# this service should be self-explanatory.
...
class HelloWorldService(ServiceBase):
    ...
    def say_hello(self, name, times):
        ...
        @return  When returning an iterable, you can use any type of python 
...
if __name__ == '__main__':
    ...
    # register the WSGI application as the handler to the wsgi server,
